...
public partial class BingoInstanceEventTypesBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.BingoInstanceEventType, dtoBB.BingoInstanceEventType>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableBingoInstanceEventType();
		...
		[HttpGet]
		[VersionedRoute(template: "BingoInstanceEventTypes/{bingoInstanceEventTypeId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int bingoInstanceEventTypeId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableBingoInstanceEventType();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, bingoInstanceEventTypeId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.BingoInstanceEventType> dbItems, int bingoInstanceEventTypeId);
