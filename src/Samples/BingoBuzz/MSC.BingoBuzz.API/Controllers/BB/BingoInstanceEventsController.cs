...
public partial class BingoInstanceEventsBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.BingoInstanceEvent, dtoBB.BingoInstanceEvent>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableBingoInstanceEvent();
		...
		[HttpGet]
		[VersionedRoute(template: "BingoInstanceEvents/{bingoInstanceEventId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid bingoInstanceEventId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableBingoInstanceEvent();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, bingoInstanceEventId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.BingoInstanceEvent> dbItems, System.Guid bingoInstanceEventId);
