...
public partial class BingoInstancesBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.BingoInstance, dtoBB.BingoInstance>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableBingoInstance();
		...
		[HttpGet]
		[VersionedRoute(template: "BingoInstances/{bingoInstanceId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid bingoInstanceId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableBingoInstance();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, bingoInstanceId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.BingoInstance> dbItems, System.Guid bingoInstanceId);
