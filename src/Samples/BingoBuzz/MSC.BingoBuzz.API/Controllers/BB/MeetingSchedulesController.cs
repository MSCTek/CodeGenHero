...
public partial class MeetingSchedulesBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.MeetingSchedule, dtoBB.MeetingSchedule>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableMeetingSchedule();
		...
		[HttpGet]
		[VersionedRoute(template: "MeetingSchedules/{meetingScheduleId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid meetingScheduleId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableMeetingSchedule();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, meetingScheduleId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.MeetingSchedule> dbItems, System.Guid meetingScheduleId);
