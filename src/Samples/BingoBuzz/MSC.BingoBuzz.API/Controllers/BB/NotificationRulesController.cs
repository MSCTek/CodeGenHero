...
public partial class NotificationRulesBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.NotificationRule, dtoBB.NotificationRule>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableNotificationRule();
		...
		[HttpGet]
		[VersionedRoute(template: "NotificationRules/{notificationRuleId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid notificationRuleId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableNotificationRule();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, notificationRuleId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.NotificationRule> dbItems, System.Guid notificationRuleId);
