...
public partial class MeetingsBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.Meeting, dtoBB.Meeting>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableMeeting();
		...
		[HttpGet]
		[VersionedRoute(template: "Meetings/{meetingId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid meetingId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableMeeting();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, meetingId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.Meeting> dbItems, System.Guid meetingId);
