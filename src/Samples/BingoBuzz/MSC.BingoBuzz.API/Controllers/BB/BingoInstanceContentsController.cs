...
public partial class BingoInstanceContentsBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.BingoInstanceContent, dtoBB.BingoInstanceContent>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableBingoInstanceContent();
		...
		[HttpGet]
		[VersionedRoute(template: "BingoInstanceContents/{bingoInstanceContentId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid bingoInstanceContentId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableBingoInstanceContent();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, bingoInstanceContentId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.BingoInstanceContent> dbItems, System.Guid bingoInstanceContentId);
