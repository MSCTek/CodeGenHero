...
public partial class RecurrenceRulesBBController : BBBaseApiController
{
	...
	= new GenericFactory<entBB.RecurrenceRule, dtoBB.RecurrenceRule>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableRecurrenceRule();
		...
		[HttpGet]
		[VersionedRoute(template: "RecurrenceRules/{recurrenceRuleId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid recurrenceRuleId)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableRecurrenceRule();
				RunCustomLogicAfterGetQueryableByPK(ref qryItem, recurrenceRuleId);
	...
	partial void RunCustomLogicAfterGetQueryableByPK(ref IQueryable<entBB.RecurrenceRule> dbItems, System.Guid recurrenceRuleId);
