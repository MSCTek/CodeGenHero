	...
	public partial class RecurrenceRulesBBController : BBBaseApiController
	{
		...
		public async Task<IHttpActionResult> Delete(System.Guid recurrenceRuleId)
		{
			try
			{
				...
				var result = await Repo.Delete_RecurrenceRuleAsync(recurrenceRuleId);
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryable_RecurrenceRule().AsNoTracking();
		...
		[HttpGet]
		[VersionedRoute(template: "RecurrenceRules/{recurrenceRuleId}/{numChildLevels:int=0}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid recurrenceRuleId, int numChildLevels)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				var dbItem = await Repo.Get_RecurrenceRuleAsync(recurrenceRuleId, numChildLevels);
		...
		public async Task<IHttpActionResult> Patch(System.Guid recurrenceRuleId, [FromBody] JsonPatchDocument<dtoBB.RecurrenceRule> patchDocument)
		{
			try
			{
				...
				var dbItem = await Repo.Get_RecurrenceRuleAsync(recurrenceRuleId, numChildLevels: 0);
				if (dbItem == null)
				{
					return NotFound();
				}
		...
		partial void RunCustomLogicAfterInsert(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.RecurrenceRule newDBItem, ref IRepositoryActionResult<entBB.RecurrenceRule> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.RecurrenceRule updatedDBItem, ref IRepositoryActionResult<entBB.RecurrenceRule> result);

		partial void RunCustomLogicAfterUpdatePut(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.RecurrenceRule updatedDBItem, ref IRepositoryActionResult<entBB.RecurrenceRule> result);
