	...
	public partial class BingoInstanceEventTypesBBController : BBBaseApiController
	{
		...
		public async Task<IHttpActionResult> Delete(int bingoInstanceEventTypeId)
		{
			try
			{
				...
				var result = await Repo.Delete_BingoInstanceEventTypeAsync(bingoInstanceEventTypeId);
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryable_BingoInstanceEventType().AsNoTracking();
		...
		[HttpGet]
		[VersionedRoute(template: "BingoInstanceEventTypes/{bingoInstanceEventTypeId}/{numChildLevels:int=0}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int bingoInstanceEventTypeId, int numChildLevels)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				var dbItem = await Repo.Get_BingoInstanceEventTypeAsync(bingoInstanceEventTypeId, numChildLevels);
		...
		public async Task<IHttpActionResult> Patch(int bingoInstanceEventTypeId, [FromBody] JsonPatchDocument<dtoBB.BingoInstanceEventType> patchDocument)
		{
			try
			{
				...
				var dbItem = await Repo.Get_BingoInstanceEventTypeAsync(bingoInstanceEventTypeId, numChildLevels: 0);
				if (dbItem == null)
				{
					return NotFound();
				}
		...
		partial void RunCustomLogicAfterInsert(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.BingoInstanceEventType newDBItem, ref IRepositoryActionResult<entBB.BingoInstanceEventType> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.BingoInstanceEventType updatedDBItem, ref IRepositoryActionResult<entBB.BingoInstanceEventType> result);

		partial void RunCustomLogicAfterUpdatePut(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.BingoInstanceEventType updatedDBItem, ref IRepositoryActionResult<entBB.BingoInstanceEventType> result);
