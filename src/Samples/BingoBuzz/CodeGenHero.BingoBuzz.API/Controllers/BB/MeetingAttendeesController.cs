	...
	= new GenericFactory<entBB.MeetingAttendee, dtoBB.MeetingAttendee>();
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableMeetingAttendee().AsNoTracking();
		...
		[HttpGet]
		[VersionedRoute(template: "MeetingAttendees/{meetingAttendeeId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid meetingAttendeeId, int numChildLevels = 0)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableMeetingAttendee().AsNoTracking();
				RunCustomLogicOnGetQueryableByPK(ref qryItem, meetingAttendeeId, numChildLevels);
		...
		partial void RunCustomLogicOnGetQueryableByPK(ref IQueryable<entBB.MeetingAttendee> qryItem, System.Guid meetingAttendeeId, int numChildLevels);
