	...
	public partial class MeetingAttendeesBBController : BBBaseApiController
	{
		...
		public async Task<IHttpActionResult> Delete(System.Guid meetingAttendeeId)
		{
			try
			{
				...
				var result = await Repo.Delete_MeetingAttendeeAsync(meetingAttendeeId);
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryable_MeetingAttendee().AsNoTracking();
		...
		[HttpGet]
		[VersionedRoute(template: "MeetingAttendees/{meetingAttendeeId}/{numChildLevels:int=0}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(System.Guid meetingAttendeeId, int numChildLevels)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				var dbItem = await Repo.Get_MeetingAttendeeAsync(meetingAttendeeId, numChildLevels);
				...
				RunCustomLogicOnGetEntityByPK(ref dbItem, meetingAttendeeId, numChildLevels);
		...
		public async Task<IHttpActionResult> Patch(System.Guid meetingAttendeeId, [FromBody] JsonPatchDocument<dtoBB.MeetingAttendee> patchDocument)
		{
			try
			{
				...
				var dbItem = await Repo.Get_MeetingAttendeeAsync(meetingAttendeeId, numChildLevels: 0);
				if (dbItem == null)
				{
					return NotFound();
				}
		...
		partial void RunCustomLogicAfterInsert(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.MeetingAttendee newDBItem, ref IRepositoryActionResult<entBB.MeetingAttendee> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.MeetingAttendee updatedDBItem, ref IRepositoryActionResult<entBB.MeetingAttendee> result);

		partial void RunCustomLogicAfterUpdatePut(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.MeetingAttendee updatedDBItem, ref IRepositoryActionResult<entBB.MeetingAttendee> result);

		partial void RunCustomLogicOnGetEntityByPK(ref entBB.MeetingAttendee dbItem, System.Guid meetingAttendeeId, int numChildLevels);
