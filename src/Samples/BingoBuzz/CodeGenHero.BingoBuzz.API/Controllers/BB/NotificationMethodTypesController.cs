	...
	public partial class NotificationMethodTypesBBController : BBBaseApiController
	{
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableNotificationMethodType().AsNoTracking();
		...
		[HttpGet]
		[VersionedRoute(template: "NotificationMethodTypes/{notificationMethodTypeId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int notificationMethodTypeId, int numChildLevels = 0)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableNotificationMethodType().AsNoTracking();
				RunCustomLogicOnGetQueryableByPK(ref qryItem, notificationMethodTypeId, numChildLevels);
		...
		partial void RunCustomLogicOnGetQueryableByPK(ref IQueryable<entBB.NotificationMethodType> qryItem, int notificationMethodTypeId, int numChildLevels);
