...
namespace CodeGenHero.BingoBuzz.API.Controllers.BB
{
	public partial class CompaniesBBController : BBBaseApiController
	{
		...
		partial void RunCustomLogicAfterInsert(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.Company newDBItem, ref IRepositoryActionResult<entBB.Company> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.Company updatedDBItem, ref IRepositoryActionResult<entBB.Company> result);

		partial void RunCustomLogicAfterUpdatePut(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.Company updatedDBItem, ref IRepositoryActionResult<entBB.Company> result);
