...
namespace CodeGenHero.BingoBuzz.API.Controllers.BB
{
	public partial class UsersBBController : BBBaseApiController
	{
		...
		partial void RunCustomLogicAfterInsert(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.User newDBItem, ref IRepositoryActionResult<entBB.User> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.User updatedDBItem, ref IRepositoryActionResult<entBB.User> result);

		partial void RunCustomLogicAfterUpdatePut(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.User updatedDBItem, ref IRepositoryActionResult<entBB.User> result);
