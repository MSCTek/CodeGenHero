	...
	= new GenericFactory<entBB.BingoInstanceStatusType, dtoBB.BingoInstanceStatusType>();
		...
		public async Task<IHttpActionResult> Delete(int bingoInstanceStatusTypeId)
		{
			try
			{
				...
				var result = Repo.DeleteBingoInstanceStatusType(bingoInstanceStatusTypeId);
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryableBingoInstanceStatusType().AsNoTracking();
		...
		[HttpGet]
		[VersionedRoute(template: "BingoInstanceStatusTypes/{bingoInstanceStatusTypeId}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int bingoInstanceStatusTypeId, int numChildLevels = 0)
		{
			try
			{
				base.OnActionExecuting();

				var qryItem = Repo.GetQueryableBingoInstanceStatusType().AsNoTracking();
				RunCustomLogicOnGetQueryableByPK(ref qryItem, bingoInstanceStatusTypeId, numChildLevels);

				var dbItem = qryItem.Where(x => x.BingoInstanceStatusTypeId == bingoInstanceStatusTypeId).FirstOrDefault();
		...
		public async Task<IHttpActionResult> Patch(int bingoInstanceStatusTypeId, [FromBody] JsonPatchDocument<dtoBB.BingoInstanceStatusType> patchDocument)
		{
			try
			{
				...
				var dbItem = Repo.GetBingoInstanceStatusType(bingoInstanceStatusTypeId);
				if (dbItem == null)
				{
					return NotFound();
				}
		...
		partial void RunCustomLogicAfterInsert(entBB.BingoInstanceStatusType newDBItem);

		partial void RunCustomLogicOnGetQueryableByPK(ref IQueryable<entBB.BingoInstanceStatusType> qryItem, int bingoInstanceStatusTypeId, int numChildLevels);
		...
		// {
			// if (numChildLevels > 0)
			// {
				// qryItem = qryItem.Include(x => x.BingoInstances).AsNoTracking()
			// }
