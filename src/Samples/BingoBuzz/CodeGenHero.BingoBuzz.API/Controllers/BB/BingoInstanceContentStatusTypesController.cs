...
namespace CodeGenHero.BingoBuzz.API.Controllers.BB
{
	public partial class BingoInstanceContentStatusTypesBBController : BBBaseApiController
	{
		...
		partial void RunCustomLogicAfterInsert(entBB.BingoInstanceContentStatusType newDBItem, IRepositoryActionResult<entBB.BingoInstanceContentStatusType> result);
