	...
	public partial class BingoInstanceContentStatusTypesBBController : BBBaseApiController
	{
		...
		public async Task<IHttpActionResult> Delete(int bingoInstanceContentStatusTypeId)
		{
			try
			{
				...
				var result = await Repo.Delete_BingoInstanceContentStatusTypeAsync(bingoInstanceContentStatusTypeId);
		...
		string fields = null, string filter = null, int page = 1, int pageSize = maxPageSize)
		{
			try
			{
				...
				var dbItems = Repo.GetQueryable_BingoInstanceContentStatusType().AsNoTracking();
		...
		[HttpGet]
		[VersionedRoute(template: "BingoInstanceContentStatusTypes/{bingoInstanceContentStatusTypeId}/{numChildLevels:int=0}", allowedVersion: 1)]
		public async Task<IHttpActionResult> Get(int bingoInstanceContentStatusTypeId, int numChildLevels)
		{
			try
			{
				if (!base.OnActionExecuting(out HttpStatusCode httpStatusCode, out string message)) { return Content(httpStatusCode, message); }
				var dbItem = await Repo.Get_BingoInstanceContentStatusTypeAsync(bingoInstanceContentStatusTypeId, numChildLevels);
		...
		public async Task<IHttpActionResult> Patch(int bingoInstanceContentStatusTypeId, [FromBody] JsonPatchDocument<dtoBB.BingoInstanceContentStatusType> patchDocument)
		{
			try
			{
				...
				var dbItem = await Repo.Get_BingoInstanceContentStatusTypeAsync(bingoInstanceContentStatusTypeId, numChildLevels: 0);
				if (dbItem == null)
				{
					return NotFound();
				}
		...
		partial void RunCustomLogicAfterInsert(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.BingoInstanceContentStatusType newDBItem, ref IRepositoryActionResult<entBB.BingoInstanceContentStatusType> result);

		partial void RunCustomLogicAfterUpdatePatch(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.BingoInstanceContentStatusType updatedDBItem, ref IRepositoryActionResult<entBB.BingoInstanceContentStatusType> result);

		partial void RunCustomLogicAfterUpdatePut(ref CodeGenHero.BingoBuzz.Repository.Entities.BB.BingoInstanceContentStatusType updatedDBItem, ref IRepositoryActionResult<entBB.BingoInstanceContentStatusType> result);
