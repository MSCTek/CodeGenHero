CREATE TABLE [dbo].[BingoInstance] (
    ...
    CONSTRAINT [FK_BingoInstance_BingoInstanceStatusType] FOREIGN KEY ([BingoInstanceStatusTypeId]) REFERENCES [dbo].[BingoInstanceStatusType] ([BingoInstanceStatusTypeId]),
